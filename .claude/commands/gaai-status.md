...
2. Read `.gaai/project/contexts/memory/project/context.md` — show project context summary
3. List any blocked items from `.gaai/project/contexts/backlog/blocked.backlog.yaml`
